document.addEventListener('DOMContentLoaded', () => {
    ...
    dom.errorAlert = document.getElementById('error-message');
    ...
    dom.categoriesLoading = document.getElementById('categories-loading');
    dom.categoriesError = document.getElementById('categories-error');
